          ...
          <div className="text-center">
            ...
            <div className="space-y-6">
              <p className="text-[18px] leading-[28.8px] font-medium tracking-tight text-[#1C303C] font-satoshi">
                This platform is built for global communities, students,
                creators, remote teams, and anyone who wants to connect beyond
                language limits.
              </p>
              <p className="text-lg md:text-xl font-bold italic text-tangelo-orange">
                Whether you speak English, French, Hausa, Arabic, Spanish — you
                belong here.
              </p>
            </div>
          </div>
